        ...
        <div className="flex flex-col md:flex-row gap-16 md:gap-24">
          ...
          <div className="w-full md:w-1/2">
            ...
            <motion.p
              ...
              className="text-white/40 text-sm leading-[1.9] mb-14"
            ...
            >
              {contactDetails.map((detail) => (
                <div key={detail.label}>
                  <p
                    className="text-white/25 text-[10px] tracking-[0.3em] uppercase mb-1.5"
                    style={{ fontFamily: 'var(--font-sans)' }}
                  >
                    {detail.label}
                  </p>
          ...
          <div className="w-full md:w-1/2">
            {submitted ? (
              ...
              >
                <div>
                  <label
                    className="block text-white/30 text-[10px] tracking-[0.3em] uppercase mb-3"
                    style={{ fontFamily: 'var(--font-sans)' }}
                  >
                    Your Name
                  </label>
                  <input
                    ...
                    className="w-full bg-transparent text-white text-sm pb-3 border-b border-white/10 focus:border-[#c9a96e] outline-none transition-colors duration-500 placeholder:text-white/15"
                    style={{ fontFamily: 'var(--font-sans)' }}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent text-white text-sm pb-3 border-b border-white/10 focus:border-[#c9a96e] outline-none transition-colors duration-500 resize-none placeholder:text-white/15"
                    style={{ fontFamily: 'var(--font-sans)' }}
